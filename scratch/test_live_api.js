...
const BASE_URL = 'https://learnozi.vercel.app';
const testEmail = `test_${Date.now()}@example.com`;
const testPassword = 'Password123!';
const testName = 'Test User';

async function runLiveTest() {
  console.log("=== STARTING LIVE API INTEGRATION TEST FOR LEARNOZI ===");
  ...
  try {
    ...
    if (todayMinutes === 25 && weekMinutes === 25 && totalSessions === 1 && sessions.length === 1 && sessions[0].subject === 'Physics') {
      console.log("\n✅ SUCCESS: Data is stored and retrieved perfectly on the live environment!");
    } else {
